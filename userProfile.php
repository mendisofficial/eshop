    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $address_rs = Database::search("SELECT * FROM `users_has_address` INNER JOIN `city` ON  users_has_address.city_city_id=city.city_id INNER JOIN `district` ON city.district_district_id=district.district_id INNER JOIN `province` ON district.province_province_id=province.province_id WHERE `users_email`='" . $email . "'");
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        ?>
                                            <img src="resources/profile_img.svg" class="rounded mt-5" style="width:150px;" />
                                        <?php
                                        } else {
                                        ?>
