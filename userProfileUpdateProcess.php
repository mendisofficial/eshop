...
if (isset($_SESSION["u"])) {
    ...
    if ($address_num == 1) {
        ...
        Database::iud("UPDATE `users_has_address` SET `line1`='" . $line1 . "', `line2`='" . $line2 . "',`postal_code`='" . $pc . "',`city_city_id`='" . $city . "' WHERE `users_email`='" . $user_email . "'");
    } else {

        Database::iud("INSERT INTO `users_has_address`(`line1`,`line2`,`postal_code`,`users_email`,`city_city_id`) VALUES ('" . $line1 . "','" . $line2 . "','" . $pc . "','" . $user_email . "','" . $city . "')");
    }
    ...
    if($user_num == 1){
        ...
        Database::iud("UPDATE `users` SET `fname`='".$fname."',`lname`='".$lname."',`email`='".$email."', `password`='".$pw."',`mobile`='".$mobile."' WHERE `email` = '" . $user_email . "'");
